...
namespace EmployeeManagementSystem.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "DepartmentRoleMappings",
                columns: table => new
                {
                    DepartmentRoleMappingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DepartmentId = table.Column<int>(type: "int", nullable: false),
                    RoleId = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DepartmentRoleMappings", x => x.DepartmentRoleMappingId);
                    table.ForeignKey(
                        name: "FK_DepartmentRoleMappings_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "DepartmentId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DepartmentRoleMappings_Roles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DepartmentRoleMappings_DepartmentId",
                table: "DepartmentRoleMappings",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_DepartmentRoleMappings_RoleId",
                table: "DepartmentRoleMappings",
                column: "RoleId");
